...
export class Node {
     ...
     */
    getNeighbors(nodeUuid, request = {}, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__getNeighbors(nodeUuid, request, requestOptions));
    }
    __getNeighbors(nodeUuid_1) {
        return __awaiter(this, arguments, void 0, function* (nodeUuid, request = {}, requestOptions) {
            var _a, _b, _c, _d;
            const _response = yield ((_a = this._options.fetcher) !== null && _a !== void 0 ? _a : core.fetcher)({
                url: core.url.join((_c = (_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.ZepEnvironment.Default, `graph/node/${encodeURIComponent(nodeUuid)}/neighbors`),
                method: "POST",
                headers: mergeHeaders((_d = this._options) === null || _d === void 0 ? void 0 : _d.headers, mergeOnlyDefinedHeaders(Object.assign({}, (yield this._getCustomAuthorizationHeaders()))), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers),
                contentType: "application/json",
                requestType: "json",
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ZepTimeoutError("Timeout exceeded when calling POST /graph/node/{node_uuid}/neighbors.");
                case "unknown":
                    throw new errors.ZepError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
