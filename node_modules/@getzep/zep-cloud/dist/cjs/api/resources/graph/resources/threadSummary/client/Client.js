...
class ThreadSummary {
    ...
    __getByGraphId(graphId, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_a = this._options.fetcher) !== null && _a !== void 0 ? _a : core.fetcher)({
                url: core.url.join((_c = (_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.ZepEnvironment.Default, `graph/thread-summary/graph/${encodeURIComponent(graphId)}`),
                method: "POST",
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ZepTimeoutError("Timeout exceeded when calling POST /graph/thread-summary/graph/{graph_id}.");
                case "unknown":
                    throw new errors.ZepError({
    ...
    __getByUserId(userId, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d;
            const _response = yield ((_a = this._options.fetcher) !== null && _a !== void 0 ? _a : core.fetcher)({
                url: core.url.join((_c = (_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.ZepEnvironment.Default, `graph/thread-summary/user/${encodeURIComponent(userId)}`),
                method: "POST",
                headers: (0, headers_js_1.mergeHeaders)((_d = this._options) === null || _d === void 0 ? void 0 : _d.headers, (0, headers_js_1.mergeOnlyDefinedHeaders)(Object.assign({}, (yield this._getCustomAuthorizationHeaders()))), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers),
                contentType: "application/json",
                requestType: "json",
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ZepTimeoutError("Timeout exceeded when calling POST /graph/thread-summary/user/{user_id}.");
                case "unknown":
                    throw new errors.ZepError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
