...
exports.SearchFilters = core.serialization.object({
    connectedNodeUuids: core.serialization.property("connected_node_uuids", core.serialization.list(core.serialization.string()).optional()),
    ...
    episodeUuids: core.serialization.property("episode_uuids", core.serialization.list(core.serialization.string()).optional()),
    ...
    sourceNodeUuids: core.serialization.property("source_node_uuids", core.serialization.list(core.serialization.string()).optional()),
    targetNodeUuids: core.serialization.property("target_node_uuids", core.serialization.list(core.serialization.string()).optional()),
